...
class SharedPreferencesManager {
  ...
  Future<bool> setBool(SharedPreferenceKey key, {required bool value}) =>
      _sharedPreferences!.setBool(key.name, value);

  bool? getBool(SharedPreferenceKey key) =>
      _sharedPreferences!.getBool(key.name);

  Future<bool> setString(SharedPreferenceKey key, {required String value}) =>
      _sharedPreferences!.setString(key.name, value);
  ...
  Future<void> remove(SharedPreferenceKey key) =>
